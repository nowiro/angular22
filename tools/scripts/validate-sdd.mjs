 ...
 * spec's acceptance criteria, are there contradictions, has the code drifted — is the
 * analyze step of the SDD ladder, which runs this script (`pnpm sdd:check`) first.
 *
 * Errors (→ exit 1):
 ...
 *
 * Passes vacuously when there are no SDD artifacts yet. Used by `pnpm sdd:check`
