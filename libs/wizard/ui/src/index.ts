/**
 * Public API for the wizard-ui library — shared wizard presentation bound to
 * Signal Forms `FieldTree`s.
 *
...
export { A22SummaryRowComponent } from './lib/summary-row.component';
