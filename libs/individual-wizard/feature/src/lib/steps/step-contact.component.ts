...
import { ADDRESS_PURPOSES, IndividualWizardStore, PHONE_KINDS } from '@angular22/individual-wizard-data';
...
/** Step 2 — e-mail, phones (FormArray-style list) and addresses. */
@Component({
...
export class StepContactComponent {
  ...
  /** Array-level errors (e.g. missing residence address) — shown once touched. */
