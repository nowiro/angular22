...
| **Framework**         | `@angular/core` · `common` · `compiler` · `forms` · `router` · `platform-browser` · `elements` · `cdk`                                        | `22.0.1`                                                                                                                                                                                                     | **wszystkie ta sama wersja**; zoneless, standalone, signals; `@angular/elements` = web components dla portalu                                                             |
...
| **Tooling**           | `husky` · `jiti` · `jsdom` · `npm-check-updates` · `@types/node`                                                                              | husky `^9.1.7` · jiti `2.7.0` · jsdom `29.1.1` · ncu `^22.2.3` · `@types/node` `25.9.3`                                                                                                                      | husky = git hooks (`prepare`); ncu = `pnpm deps:check` / `deps:update`                                                                                                    |
